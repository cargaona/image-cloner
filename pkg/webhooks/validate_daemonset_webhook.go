...
func (a *DaemonsetImageValidator) Handle(ctx context.Context, req admission.Request) admission.Response {
...
func (a *DaemonsetImageValidator) InjectDecoder(d *admission.Decoder) error {
	a.decoder = d
	return nil
}
